...
| 6 | [Анализ зависимостей и поиск закономерностей в данных портала StackOverFlow](project_nps) | Анализ данных телекоммуникационной компании и определение уровня лояльности клиентов | SQL, python ,pandas
